...
# Напишите программу банкомат. Начальная сумма равна нулю. Допустимые действия:
# пополнить, снять, выйти. Сумма пополнения и снятия кратны 50 у.е.
...
Введите значение, кратное {FREQUENCY_RATE_SUM}: "))
        if check_input(sum_for_give_up):
            ...
            log_in_file("Пополнение", sum_for_give_up, total_sum)
            return total_sum
        else:
